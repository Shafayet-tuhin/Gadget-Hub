    ...
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-side">
        ...
        <ul className="menu bg-[#416b6b] text-white min-h-full w-80 p-4 text-[0.9rem]">
          ...
          <li><Link className="hover:text-orange-400" to="/menu"> <MdMenuBook /> Our Product</Link></li>
          <li><Link className="hover:text-orange-400" to="/order"><GiLaptop /> Order Item</Link></li>
