...
const Nav = () => {
  ...
  const navOption = (
    <>
      ...
      <li><Link className="hover:text-orange-400" to="/menu">Our Products</Link></li>
      <li><Link className="hover:text-orange-400" to="/order">Order Item</Link></li>
  ...
  return (
    <div className="navbar fixed z-10 opacity-70 bg-black max-w-screen-xl rounded-xl text-white font-abc">
      <div className="navbar-start">
        ...
        <Link to="/" className="px-4 text-white bg-opacity-20 border-none lg:text-xl font-medium font-abc hover:text-orange-400">
          Gadget-Hub
        </Link>
      </div>
